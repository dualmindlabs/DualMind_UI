  ...
  async checkBackendAvailability() {
    ...
    if (window.DUALMIND_CONFIG?.offline?.enabled === false) {
      try {
        ...
        // Use same-origin so the Cloudflare Worker can proxy to the backend and add CORS headers.
        ...
        console.log('⚠️ Backend not available, running in offline mode', error.message);
      }
    } else {
